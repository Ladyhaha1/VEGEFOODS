														...
														<c:forEach var="userProducts" items="${userProducts}">
															...
															<tr class="text-center">
																<td class="product-remove">
																	<%-- <form
																		action="${pageContext.request.contextPath}/cart/delete/${userProducts.productId.productId}"
																		method="post">
																		<button type="submit"
																	...
																	<div class="input-group mb-3">
																		<div class="input-group justify-content-center">
																			<a type="button"
																				...
																				class="button-minus" id="button-minus">
																				- </a>
																			<div class="quantity-field">
																				${userProducts.quantity }</div>
																			<a type="button"
																				href="${pageContext.request.contextPath}/cart/plus/${userProducts.productId.productId}"
																				class="button-plus" id="button-plus"> +
																			</a>
																		</div>
